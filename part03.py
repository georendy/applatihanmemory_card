...
LIST_TANYA.append(Question("HARI SENIN HARI APA?", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY"))
LIST_TANYA.append(Question("sudah minum belum", "sudah", "belum 2 kali", "sudah 3 kali", "ngak makan"))
LIST_TANYA.append(Question("HARI MINGGU HARI APA?", "SUNDAY", "TUESDAY", "WEDNESDAY", "THURSDAY"))
...
def next_question():
    ...
    jendela.total_pertanyaan += 1 ## ini menambah total pertanyaan
...
def periksa_jawaban():
    if LIST_TOMBOL[0].isChecked() : ## jika memilih jawaban benar
